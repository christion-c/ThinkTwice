...
export default function NotificationsSettings() {
  ...
  useEffect(() => {
    const prepareNotifications = async () => {
      ...
      setPermissionGranted(settings.status === ExpoNotifications.PermissionStatus.GRANTED || settings.ios?.status === ExpoNotifications.IosAuthorizationStatus.PROVISIONAL);
    };
  ...
  const requestNotificationPermission = async () => {
    ...
    const granted = settings.status === ExpoNotifications.PermissionStatus.GRANTED || settings.ios?.status === ExpoNotifications.IosAuthorizationStatus.PROVISIONAL;
