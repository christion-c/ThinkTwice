...
place, and so prediction.py can import these without pulling in FastAPI
app setup or routing.
"""
...
class BudgetEntry(BaseModel):
    ...
    name or its camelCase alias, since the backend forwards the frontend's
    camelCase JSON as-is rather than translating it first.
    """
...
class PredictResponse(BaseModel):
    ...
    which mirrors this shape field-for-field (kept in sync by hand, since
    Python and TypeScript can't share a type definition directly).
    """
